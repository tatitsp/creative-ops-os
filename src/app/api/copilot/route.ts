...
const MOCK_RESPONSES = [
  "The most urgent thing right now is the HipHopDX photos — Kaito is away and that was due yesterday. Someone needs to pull from existing approved selects and get those over today. Tatiyana or Amara can handle the file delivery if Kaito stays unreachable.\n\nAfter that: the REPENT! teaser copy is sitting in review waiting on Key's sign-off. That one's a quick grab — 10 minutes and it's unblocked.",
