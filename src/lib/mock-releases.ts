...
export const MOCK_RELEASES: Release[] = [
  ...
  {
    id: "valentines-heartbreak",
    title: "Valentines Heartbreak",
    artist: "Lil Tony Official",
    type: "ALBUM",
    status: "RELEASED",
    ...
    trackCount: 10,
    leadSingles: [],
    description: "Valentines Heartbreak — released Valentine's Day 2026.",
    milestones: [],
    contentDrops: [],
    assets: [],
    approvals: [],
  ...
  {
    id: "mrs-key-deluxe",
    title: "Mrs.Key Deluxe",
    artist: "Lil Tony Official",
    type: "ALBUM",
    status: "RELEASED",
    releaseDate: "2026-03-08",
    announcementDate: "2026-02-20",
    coverArt: "https://i.scdn.co/image/ab67616d0000b273efe470094cb9bb5b6921adca",
    trackCount: 14,
    leadSingles: [],
    description: "Deluxe edition of Mrs.Key with additional tracks.",
    milestones: [],
    contentDrops: [],
    assets: [],
    approvals: [],
