...
export const MOCK_RICH_APPROVALS: RichApproval[] = [
  {
    ...
    description:
      'Full director\'s cut of the "Gravity" music video. Color graded, mixed, and captioned. Premieres on YouTube June 3 — needs management approval before scheduling the premiere.',
    type: "content",
    stage: "MANAGEMENT_APPROVAL",
    status: "PENDING",
    campaign: "Gravity — Single Push",
    campaignId: "c2",
    thumbnail: undefined,
    ...
    history: [
      {
        ...
        note: "v3 is the one. Color grade is locked, captions are corrected, audio sync is clean. This is the premiere cut.",
      },
      {
        id: "h1-2",
        stage: "INTERNAL_REVIEW",
        ...
        note: "Watched the full cut — this is strong. Passing to management approval. Key needs to green-light before we schedule the premiere.",
      },
      {
        id: "h1-3",
        stage: "MANAGEMENT_APPROVAL",
  ...
  {
    id: "ra4",
    title: '"Gravity" — Vertical edit (60s cut)',
    description:
      '60-second vertical cut of "Gravity" formatted for IG Reels and TikTok. Posts simultaneously with the YouTube premiere on June 3. Captioned and color matched to the full MV.',
    type: "content",
    stage: "MANAGEMENT_APPROVAL",
    status: "PENDING",
    campaign: "Gravity — Single Push",
    ...
    history: [
      {
        ...
        note: "Cut the 60s from the director's cut — hooks in at 0:08, drops at 0:22. Captions match the full version. This needs to go live the moment the YouTube premiere starts.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      'Behind-the-scenes reel from the "Gravity" MV shoot. 8 clips, raw and unfiltered. Kaito captured the full day — wardrobe, set, and the final take. Scheduled to drop June 10 alongside the pre-save push.',
    type: "content",
    stage: "SCHEDULED",
    status: "APPROVED",
    ...
    campaignId: "c1",
    thumbnail: undefined,
    submitter: MOCK_USERS[4], // Kaito
    submittedAt: "2026-05-24T14:00:00Z",
    ...
    history: [
      {
        ...
        note: "8 clips from shoot day. The last take moment is the one — you'll know when you see it.",
      },
      {
        id: "h8-2",
        stage: "INTERNAL_REVIEW",
        ...
        note: "This is exactly the behind-the-scenes energy we need. Moving to artist review.",
      },
      {
        id: "h8-3",
        stage: "ARTIST_REVIEW",
      ...
      },
      {
        ...
        note: "Real. Post it with the pre-save drop.",
      },
      {
        id: "h8-5",
        stage: "MANAGEMENT_APPROVAL",
      ...
      },
      {
        ...
        note: "Scheduled for June 10 to drop with the pre-save campaign launch.",
      },
    ],
  },
];
